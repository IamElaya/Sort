...
describe Barracks do
  ...
  describe "#can_train_peasant?" do
    ...
    it "returns false if there isn't enough gold" do
      ...
      # Stubbing out the gold method inside @barracks
      # In the code below, when that code calls @barracks.gold
      # return 89 instead of the real value
      #
      # Another way to write this test
      # train a bunch of units until you get below 90
      expect(@barracks.can_train_peasant?).to be_falsey
    end
  end
